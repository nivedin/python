...
# cal.geometry("2657x1250")
operator=""
text_Input=StringVar()
txtDisplay=Entry(cal,font=("arial",20,"bold"),textvariable=text_Input,bd=30,insertwidth=8,bg="powder blue",justify="right").grid(columnspan=4)
...
btnClear=Button(cal,padx=16,pady=16,bd=8,fg="black",font=("arial",29,"bold"),text="C",bg="powder blue",command=btnClearDisply).grid(row=4,column=0)
...
btnequal=Button(cal,padx=16,pady=16,bd=15,fg="black",font=("arial",20,"bold"),text="=",bg="powder blue",command=btnEqualsInput).grid(row=4,column=2)
